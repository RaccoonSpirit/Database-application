...
class MainWindow(QMainWindow):
    def __init__(self,db):
        ...
        table_servicemans.triggered.connect(lambda:self.output_table(self.db.get_serviceman(),self.db.get_columns('Serviceman')))
        table_weapon.triggered.connect(lambda:self.output_table(self.db.get_weapon(),self.db.get_columns('Weapon')))
        servicemans_weapon.triggered.connect(lambda:self.output_table(self.db.get_weapon_and_serviceman(),['FIO','Rank','Type_of_weapon','Name']))
